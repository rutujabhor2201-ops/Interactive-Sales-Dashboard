...
| `Total_Sales` | Total sales value of the transaction  |
...
```text
visualizations/price_boxplot.png
```
...
```text
visualizations/sales_violin.png
```
...
```text
visualizations/customer_segment_sales.png
```
